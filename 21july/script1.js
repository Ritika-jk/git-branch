...
if (products.length ===0){
  ...
  emptycontainer.innerText= "No Products Found"
  productsContainer.appendChild(emptycontainer)
}

products.forEach((product) => {const productsCard = document.createElement('div');
